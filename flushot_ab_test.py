...
2. Social Proof: "4 of your neighbors have got a flushot. get yours now! Will you get a flu shot?"
...
def run_flushot_ab_test():
    ...
    logger.info("Running flu shot A/B test experiment...")
    ...
    test_question = "4 of your neighbors have got a flushot. get yours now! Will you get a flu shot?"
    options = ["Yes", "No"]
...
def create_visualization(control_yes_rate, test_yes_rate):
    ...
    try:
        ...
        # Create bar chart
        groups = ['Standard Message', 'Social Proof Message']
        ...
        plt.title('Effect of Social Proof on Flu Shot Acceptance')
        ...
        # Save the figure
        plt.savefig('flushot_ab_test_results.png')
        logger.info("Visualization saved to flushot_ab_test_results.png")
