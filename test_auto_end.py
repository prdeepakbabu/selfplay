#!/usr/bin/env python3
"""
Test script for the auto-end feature in bot-to-bot conversations.
"""
...
def main():
    ...
    initial_message = "Can you explain decimal division for a 5th grader?"
    
    # Number of turns for the conversation
    num_turns = 10
    
    print(f"\n{'='*80}\nBOT-TO-BOT CHAT WITH AUTO-END FEATURE\n{'='*80}\n")
    ...
    # Run the interaction with auto_end enabled
    conversation_history = bot1.interact(
        ...
        filename="/Users/badeepak/Downloads/testi.html"
    )
